  ...
  return (
    <div className="relative flex flex-1 items-center overflow-hidden bg-ink-950 text-white">
      ...
      <Container className="relative py-32 text-center">
        ...
        <h1 className="mt-2 text-4xl font-extrabold uppercase">Aquí no hay fuego</h1>
        <p className="mx-auto mt-3 max-w-md text-ink-300">La página que buscas no existe o se ha movido. Vuelve al inicio y sigue explorando el club.</p>
